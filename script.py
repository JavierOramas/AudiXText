...
def Audio(file=Argument(), lang=Argument(default='es-ES'), noise_span = Option(default=1), show_alt = Option(default=False)):
...
def Text(text = Argument(), lang = Argument(default='es')):
